...
import 'package:lab3/widgets/exam_list.dart';
import 'package:lab3/widgets/new_exam.dart';

enum MenuAction { addExam, logout, login }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        // ExamList is a custom widget
        child: ExamList(exams: _exams, onDelete: _deleteExam),
      ),
    );
  }
